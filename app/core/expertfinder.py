...
def find_bio_experts_dummy(bio_sim, query_text, location_filter, top):
    summary_agent = agent_text('agents/bio_expert_summarize.txt')
    explain_agent = agent_text('agents/bio_documents_explain.txt')
    dct = {'Query': 'How can a plane fly more efficient?',
     ...
     'Authors': [{'author_name': 'Mayr, Gerald',
       ...
       'sources': ['[1] Mayr G., “Pectoral girdle morphology of Mesozoic birds and the evolution of the avian supracoracoideus muscle,” <i>Journal of Ornithology</i>, vol. 158, no. 3, pp. 859-867, 2017. DOI: <a href="https://doi.org/10.1007/s10336-017-1451-x">10.1007/s10336-017-1451-x</a>.',
        ...
        '[8] Mayr G., “A new Eocene swift-like bird with a peculiar feathering,” <i>Ibis</i>, vol. 145, no. 3, pp. 382-391, 2003. DOI: <a href="https://doi.org/10.1046/j.1474-919X.2003.00168.x">10.1046/j.1474-919X.2003.00168.x</a>.',
        '[9] Mayr G., “New specimens of Hassiavis laticauda (Aves: Cypselomorphae) and Quasisyndactylus longibrachis (Aves: Alcediniformes) from the Middle Eocene of Messel, Germany,” <i>CFS Courier Forschungsinstitut Senckenberg</i>, vol. nan, no. 252, pp. 23-28, 2004. DOI: <a href="https://doi.org/nan">nan</a>.',
        '[10] Mayr G.; Goedert J.L., “New late Eocene and Oligocene remains of the flightless, penguin-like plotopterids (Aves, Plotopteridae) from western Washington State, U.S.A.,” <i>Journal of Vertebrate Paleontology</i>, vol. 36, no. 4, pp. nan-nan, 2016. DOI: <a href="https://doi.org/10.1080/02724634.2016.1163573">10.1080/02724634.2016.1163573</a>.',
        '[11] Mayr G.; Goedert J.L., “New late Eocene and Oligocene plotopterid fossils from Washington State (USA), with a revision of Tonsala buchanani (Aves, Plotopteridae),” <i>Journal of Paleontology</i>, vol. 96, no. 1, pp. 224-236, 2022. DOI: <a href="https://doi.org/10.1017/jpa.2021.81">10.1017/jpa.2021.81</a>.',
        '[12] Mayr G., “The coracoscapular joint of neornithine birds—extensive homoplasy in a widely neglected articular surface of the avian pectoral girdle and its possible functional correlates,” <i>Zoomorphology</i>, vol. 140, no. 2, pp. 217-228, 2021. DOI: <a href="https://doi.org/10.1007/s00435-021-00528-2">10.1007/s00435-021-00528-2</a>.',
        '[13] Mayr G.; Manegold A., “On the comparative morphology of the juvenile avian skull: An assessment of squamosal shape across avian higher-level taxa,” <i>Anatomical Record</i>, vol. 304, no. 4, pp. 845-859, 2021. DOI: <a href="https://doi.org/10.1002/ar.24504">10.1002/ar.24504</a>.']},
